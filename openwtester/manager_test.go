...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO PIZ", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W2kgcfhPLc6LQeLHVK8CtztC9ab6bsuF2p")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "pizopenw3333", WalletID: walletID, Required: 1, Symbol: "PIZ", IsTrust: true}
