...
func (decoder *TransactionDecoder) CreateRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	...
	totalSend := amountDec.Add(FixFee)
	if accountBalanceDec.LessThan(totalSend) {
...
func (decoder *TransactionDecoder) SubmitRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) (*openwallet.Transaction, error) {
	...
	txjson, _ := json.Marshal(stx.Transaction)
	decoder.wm.Log.Debug(string(txjson))
...
func (decoder *TransactionDecoder) CreateSummaryRawTransactionWithError(wrapper openwallet.WalletDAI, sumRawTx *openwallet.SummaryRawTransaction) ([]*openwallet.RawTransactionWithError, error) {
	...
	if accountBalanceDec.LessThan(minTransfer) || accountBalanceDec.LessThanOrEqual(FixFee) {
		return rawTxArray, nil
	}
