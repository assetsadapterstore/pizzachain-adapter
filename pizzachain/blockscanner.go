...
func (bs *PIZBlockScanner) forkBlockNotify(block *Block) {
...
//newBlockNotify 获得新区块后，通知给观测者
func (bs *PIZBlockScanner) newBlockNotify(block *eos.BlockResp) {
...
func (bs *PIZBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *PIZBlockScanner) extractTxInput(action TransferAction, txExtractData *openwallet.TxExtractData) {
...
func (bs *PIZBlockScanner) extractTxOutput(action TransferAction, txExtractData *openwallet.TxExtractData) {
...
func (bs *PIZBlockScanner) newExtractDataNotify(height uint64, extractData map[string][]*openwallet.TxExtractData) error {
	if extractData == nil {
		return nil
	}
...
func (bs *PIZBlockScanner) scanBlock(height uint64) (*eos.BlockResp, error) {
